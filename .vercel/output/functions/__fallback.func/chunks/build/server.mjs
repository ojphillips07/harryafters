import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, h, getCurrentInstance, ref, computed, inject, provide, toValue, mergeProps, unref, createVNode, resolveDynamicComponent, watch, withCtx, renderSlot, openBlock, createBlock, toDisplayString, useSlots, createCommentVNode, Comment, cloneVNode, shallowRef, resolveComponent, toRef, camelize, useModel, createTextVNode, mergeModels, isRef, hasInjectionContext, Fragment, onServerPrefetch, defineAsyncComponent, createElementBlock, useSSRContext, Suspense, createApp, renderList, useId, shallowReactive, onErrorCaptured, reactive, effectScope, nextTick, toRefs, useTemplateRef, withModifiers, normalizeProps, guardReactiveProps, watchEffect, normalizeStyle, getCurrentScope, Teleport, markRaw, toHandlerKey, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, o as klona, q as defu, p as parseQuery, r as defuFn, v as hasProtocol, n as joinURL, x as parseURL, i as encodePath, y as decodePath, z as isEqual, w as withQuery, A as isScriptProtocol, B as getContext, C as withTrailingSlash, D as withoutTrailingSlash, E as sanitizeStatusCode, $ as $fetch$1, F as baseURL, c as createError$1, G as executeAsync } from '../_/nitro.mjs';
...
import { unrefElement, useDebounceFn, reactivePick, reactiveOmit, onKeyStroke, useVModel, useMounted, createSharedComposable, useRafFn, defaultWindow } from '@vueuse/core';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cuktv8mO.mjs')
  }
];
      ...
      _push(ssrRenderComponent(_component_UApp, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UFooter, { class: "border-t border-gray-800 bg-gray-950/50 backdrop-blur-md py-8" }, {
              left: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col gap-2"${_scopeId2}><p class="text-sm text-gray-400"${_scopeId2}>${ssrInterpolate(unref(eventName))} • Fairfax Year 13 Prom After Party </p><p class="text-xs text-gray-500"${_scopeId2}> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} • Non-profit event </p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex flex-col gap-2" }, [
                      createVNode("p", { class: "text-sm text-gray-400" }, toDisplayString(unref(eventName)) + " • Fairfax Year 13 Prom After Party ", 1),
                      createVNode("p", { class: "text-xs text-gray-500" }, " © " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " • Non-profit event ", 1)
                    ])
                  ];
                }
              }),
            ...
            return [
              ...
              createVNode(_component_UFooter, { class: "border-t border-gray-800 bg-gray-950/50 backdrop-blur-md py-8" }, {
                left: withCtx(() => [
                  createVNode("div", { class: "flex flex-col gap-2" }, [
                    createVNode("p", { class: "text-sm text-gray-400" }, toDisplayString(unref(eventName)) + " • Fairfax Year 13 Prom After Party ", 1),
                    createVNode("p", { class: "text-xs text-gray-500" }, " © " + toDisplayString((/* @__PURE__ */ new Date()).getFullYear()) + " • Non-profit event ", 1)
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BEC8CLaF.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CN1vDCXR.mjs'));
...
export { Primitive as P, __nuxt_component_0$1 as _, useForwardExpose as a, useAppConfig as b, useComponentUI as c, formInputsInjectionKey as d, entry_default as default, formFieldInjectionKey as e, formErrorsInjectionKey as f, useFormField as g, useFieldGroup as h, inputIdInjectionKey as i, useComponentIcons as j, _sfc_main$g as k, _sfc_main$e as l, looseToNumber as m, useEventBranding as n, _sfc_main$b as o, tv as t, useHead as u };
