...
const styles = {
  "pages/index.vue": () => import('./index-styles.BBgS0N77.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=12bb94d8&lang.css": () => import('./index-styles.BBgS0N77.mjs').then(interopDefault),
